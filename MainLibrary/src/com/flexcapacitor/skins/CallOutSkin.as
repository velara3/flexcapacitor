...
package com.flexcapacitor.skins
{
	...
	/**
	 *  Based on the default skin class for the Spark Callout component in desktop applications 
	 * but makes properties public so this class can be subclassed and UI options modified. 
	 * 
	...
	public class CallOutSkin extends ActionScriptSkinBase
	{
		 ...
		 *  @productversion Flex 4.6
		 */
		public var useBackgroundGradient:Boolean = true;
		 ...
		 *  @productversion Flex 4.6
		 */
		public var contentCornerRadius:uint;
		 ...
		 *  @productversion Flex 4.6
		 */
		public var contentBackgroundInsetClass:Class;
		 ...
		 *  @productversion Flex 4.6
		 */
		public var backgroundCornerRadius:Number;
		 ...
		 *  @productversion Flex 4.6
		 */
		public var frameThickness:Number;
		...
		/**
		 * Indicates if the arrow should be visible
		 * */
		...
		public var backgroundGradientHeight:Number;
		
		public var contentMask:Sprite;
		
		public var backgroundFill:SpriteVisualElement;
		
		public var dropShadow:RectangularDropShadow;
		
		public var dropShadowBlurX:Number;
		
		public var dropShadowBlurY:Number;
		
		public var dropShadowDistance:Number;
		
		public var dropShadowAngle:Number;
