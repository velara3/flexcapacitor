...
package com.flexcapacitor.effects.sound.supportClasses {
	 ...
	 *  @copy PlaySound
	 */  
	public class PlaySoundInstance extends ActionEffectInstance
	{
		 ...
		 */
		public function PlaySoundInstance(target:Object)
		{
			super(target);
		}
		...
		/** 
		 *  Reference to the internal Sound object. The PlaySound uses this
		...
		override public function play():void { 
			...
			if (!isNaN(panFrom) || !isNaN(panTo)) {
				...
				panTween.setTweenHandlers(onPanTweenUpdate, onPanTweenEnd);
		...
		override public function finishEffect():void
		{
			...
			// we may need to call these at some point
		...
		mx_internal function onPanTweenUpdate(value:Object):void {
			var copyTransform:SoundTransform;
				
			if (soundChannel) {
				// Need to reset the soundTransform object in order
				copyTransform = soundChannel.soundTransform;
