...
package com.flexcapacitor.effects.sound {
	
	import com.flexcapacitor.effects.sound.supportClasses.PlaySoundInstance;
	...
	public class PlaySound extends ActionEffect {
		 ...
		 */
		public function PlaySound(target:Object = null) {
			...
			instanceClass = PlaySoundInstance;
		...
		/** 
		 *  The PlaySound class uses an internal Sound object to control
		 *  the MP3 file.
		...
		override protected function initInstance(instance:IEffectInstance):void
		{
			...
			var playSoundInstance:PlaySoundInstance =
				PlaySoundInstance(instance);
			
			playSoundInstance.source = source;
			playSoundInstance.sound = sound;
			playSoundInstance.panFrom = panFrom;
			playSoundInstance.panTo = panTo;
			playSoundInstance.volumeFrom = volumeFrom;
			playSoundInstance.volumeTo = volumeTo;
			playSoundInstance.panEasingFunction = panEasingFunction;
