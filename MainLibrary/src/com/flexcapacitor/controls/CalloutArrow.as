package com.flexcapacitor.controls
{
	...
	public class CalloutArrow extends UIComponent
	{
		 ...
		 */
		public var useBackgroundGradient:Boolean;
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			var hostComponent:spark.components.Callout = calloutSkin.hostComponent;
			...
			useBackgroundGradient = hostComponent.getStyle("useBackgroundGradient");
			...
			backgroundColor = hostComponent.getStyle("backgroundColor");
			backgroundAlpha = hostComponent.getStyle("backgroundAlpha");
			...
			if (showBorder)
			{
				arrowGraphics.lineStyle(borderThickness, borderColor, borderAlpha, true);
			}
